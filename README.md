About credstash-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/credstash-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/fugue/credstash
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6289&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/credstash-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `credstash` can be installed with `conda`:
...
```
mamba install credstash
```

It is possible to list all of the versions of `credstash` available on your platform with `conda`:
...
```
mamba search credstash --channel conda-forge
```
...
mamba repoquery search credstash --channel conda-forge

# List packages depending on `credstash`:
mamba repoquery whoneeds credstash --channel conda-forge

# List dependencies of `credstash`:
mamba repoquery depends credstash --channel conda-forge
```
